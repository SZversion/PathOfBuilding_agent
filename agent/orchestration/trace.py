...
class TraceRecorder:
    ...
    def _event(self, name, stage, status, *, attempt=1, max_attempts=None, provider=None, tool=None, step_index=None, tool_call_count=None, retry_of=None, plan_ref=None, safe_args_ref=None, error_ref=None, result_ref=None, prompt_ref=None, duration_ms=None):
